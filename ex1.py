...
def Nonogram():
    ...
    #*******************************************************************************************************************************
    file = 'C:/Users/HP/Desktop/15-112/Project 15-112/Project folder15-112/Batch/GUIpanda.jpg'
    ...
    def draw():
        ...
        for j in range(len(CountRow)):
            ...
            for i in range(len(List1)):              
                ...
                screen.blit(text1, (ext * dif +k + 15, j * dif - 5)) 
                k += dif 
        ...
        for i in range(len(CountCol)):
            ...
            for j in range(len(List1)):   
                ...
                screen.blit(text1, (i * dif + 15, ext * dif + k - 5)) 
                k += dif
    ...
    def instruction():
        ...
        text2 = font2.render("YOU EARN 20% TO YOUR HEALTH BAR EVERY 5 CORRECT ATTEMPTS", 1, (0, 0, 0))
        text3 = font2.render("AND LOSE 20 FOR EVERY MISTAKE", 1, (0, 0, 0))
    ...
    def result():
        text1 = font1.render("GAME OVER", 1, (0, 0, 0))
        screen.blit(text1, (20, 570))   
    ...
    while run:
        ...
        if win == 1:
            ...
            text1 = font1.render("Congratulations!!!", 3, (255, 0, 0))
            screen.blit(text1, (500,300)) 
            img = cv2.imread('Batch/GUIpanda.jpg')  
            cv2.imshow("Panda", img) 


        if gameOver == 1:  
            pygame.draw.rect(screen, (255,255,255), (0, 0, 700, 600))
            text1 = font1.render("GAME OVER!!!", 3, (255, 0, 0))
            screen.blit(text1, (500,200))  
            text1 = font1.render("Press K to try again", 3, (255, 0, 0))
            screen.blit(text1, (500,300)) 
